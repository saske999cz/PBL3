    ...
    public partial class FormTTNV : Form
    {
        ...
        public FormTTNV(string theme, string ID_Employee)
        {
            ...
            switch (theme)
            {
                ...
                case "Dark":
                    ...
                    tbStartDate.DisabledState.FillColor = Color.FromArgb(40, 35, 40);                    tbIDNV.DisabledState.BorderColor = Color.FromArgb(40, 35, 40);
        ...
        private void FormTTNV_Load(object sender, EventArgs e)
        {
            using (BookStoreContext context = new BookStoreContext())
            {
                ...
                tbEndDate.Text = employee.EndDate == null ? "" : employee.EndDate.Value.ToString("dd/MM/yyyy");
